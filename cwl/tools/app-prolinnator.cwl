...
label: "App-StabiliNNator (Proline) - BV-BRC Application"
doc: |
  BV-BRC application wrapper for proliNNator analysis.
  Uses App-StabiliNNator.pl service script with analysis_type=proline.
...
outputs:
  annotated_structure:
    type: File
    outputBinding:
      glob: "output/*_proline.pdb"
    doc: "PDB with proline mutation scores as B-factors"

  scores_csv:
    type: File
    outputBinding:
      glob: "output/*_proline.csv"
